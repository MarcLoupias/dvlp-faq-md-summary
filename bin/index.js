...
const marked_renderer_md_impl_1 = require("./marked-renderer-md-impl");
...
const markedRenderer = Object.assign(new marked.Renderer(), { ...marked_renderer_md_impl_1.default });
const markedOptions = {
...
exports.default = new MapReduceToMdImplPkg();
